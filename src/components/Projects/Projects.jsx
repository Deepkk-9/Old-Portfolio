    ...
    return (
        <sec id="ProjectSec">
            ...
            <div className="ProjectCards">
                <div id="top">
                    <h2> <img src="/assets/icons/icons8-python.svg" alt="bot" />&nbsp; iNoteBook</h2>
                    <p>
                        User developed and implemented iNoteBook, a cloud-based task management system with real-time access, seamless note management, and increased productivity
                    </p>
                    <Githubp />
                </div>
